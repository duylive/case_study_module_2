        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">update the weapon<small>It's free!</small></h3>
                </div>
                <div class="panel-body">
                    <form role="form" method="post">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="series" id="last_name" class="form-control input-sm"
                                           placeholder=" series">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="type_id" id="password" class="form-control input-sm"
                                           placeholder="type_id">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="size_bullet_id" id="password_confirmation"
                                           class="form-control input-sm" placeholder="size_bullet_id ">
                                </div>
                            </div>
                        </div>
